---
title: 'Quantifizierung und regionale Trends des Facharztmangels im Öffentlichen Gesundheitsdienst (ÖGD)'
...
# Tabelle 1: Kummulierte prozentuale Änderung der Anzahl an tätigen Fachärzt/innen von 1998 bis 2018 nach Ärztlicher Tätigkeit unterschieden zwischen Gesamtheit aller Facharztrichtungen, in Behöroden/Körperschaften o.ä. und Öffentliches Gesundheitswesen
...
# Abbildung 2: Bei den Ärztekammern registrierte tätigen Ärztinnen und Ärzte mit Facharztbezeichnung Öffentliches Gesundheitswesen nach Region von 1998 bis 2018 in Deutschland
```{r, fig2}
...
# Tabelle 2: Bei den Ärztekammern registrierte tätigen Ärztinnen und Ärzte mit Facharztbezeichnung Öffentliches Gesundheitswesen nach Region von 1998 bis 2018 in Deutschland
```{r, Tabelle 2, results='asis'}
data <- read_gbe_files(file = "191022_Region_nurOEGW.csv", variables = c("Region"))

kable(data %>% spread(key = "Jahr", value = "n") %>% arrange(desc(`2005-12-31`)))
```
...
# Tabelle 3: Bei den Ärztekammern registrierte tätigen Ärztinnen und Ärzte für ausgewählte Facharztrichtungen in Deutschland zwischen 1998 und 2017
```{r}
data <- read_gbe_files(file = "191022_Facharzt_nurTaetige.csv", variables = c("Facharzt"))
...
### Tabelle 3a: Bei den Ärztekammern registrierte tätigen Ärztinnen und Ärzte nach Facharztrichtungen in Deutschland zwischen 1998 und 2018
```{r, Tabelle 3a}
data <- read_gbe_files(file = "191022_Facharzt_nurTaetige.csv", variables = c("Facharzt"))
...
### Tabelle 3b: Bei den Ärztekammern registrierte in Behörden, Körperschaften oder ähnlichen Einrichtungen tätigen Ärztinnen und Ärzte nach Facharztrichtungen in Deutschland zwischen 1998 und 2018
```{r, Tabelle 3b}
